        ...
        <div class="wrap-login100 p-l-55 p-r-55 p-t-20 p-b-30">
            <form name="f1" action="authentication_signup.php" method="POST" class="login100-form validate-form">
                ...
                <div class="wrap-input100 validate-input m-b-20" data-validate="Enter first name">
                    <input class="input100" type="text" id="name" name="name" placeholder="Enter First name*" pattern="[A-Za-z]{1,26}" title="Name can only contain Alphabets" required="" />
                ...
                <div class="wrap-input100 validate-input m-b-20" data-validate="Enter email">
                    <input class="input100" type="text" id="email" name="email" placeholder="E-mail(Uername)*" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" title="Enter valid email" required="" />
                    <span class="focus-input100"></span>

                </div>

                <div class="wrap-input100 validate-input m-b-20" data-validate="Enter mobile number">
                    <input class="input100" type="text" id="phone" name="phone" placeholder="Phone number*" pattern="[6-9]{1}[0-9]{9}" title="Enter valid mobile number" required="" />
                    <span class="focus-input100"></span>
                </div>
